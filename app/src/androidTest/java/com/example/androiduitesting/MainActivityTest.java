...
public class MainActivityTest {
    ...
    @Test
    public void TestShowActivityOpen() {
        // Add first city to the list
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withId(R.id.city_name)).check(matches(isDisplayed()));  // Stuff in ShowActivity
        onView(withId(R.id.back_button)).check(matches(isDisplayed()));
    }

    @Test
    public void TestShowActivityText() {
        // Add first city to the list
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list)).atPosition(0).perform(click());
        onView(withText("Edmonton")).check(matches(isDisplayed()));  // Edmonton
    }

    @Test
    public void TestShowActivityBackButton() {
        // Add first city to the list
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withId(R.id.city_list)).check(matches(isDisplayed()));  // City list on main activity
    }
}
